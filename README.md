...
<pre>ps: O APP_URL do laravel para está definido como <strong>localhost:8001</strong>, <br/>preferencialmente executando nessa ordem nem uma ação a mais será necessária</pre> 
